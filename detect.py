# Modify 16 lines   Modify 131 to 135 lines
import argparse
import time
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        try:
                            ...
                            plot_one_box(xyxy, im0, label=label, color=colors[int(cls)], line_thickness=opt.thickness)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--thickness', type=int, default=1, help='font size')
